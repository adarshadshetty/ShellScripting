...
bucket_name="adarsha-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="adarshadshetty18@gmail.com"
...
aws sns publish \
  ...
  --message "Hello EveryOne for this project please refer ULTIMATE SHELL SCRIPTING PROJECT | USED BY NETFLIX | LIVE DEMO | AWS REAL-TIME PROJECT | ->https://www.youtube.com/watch?v=ZOGeOmla5Sw"
